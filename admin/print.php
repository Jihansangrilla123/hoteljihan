...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>Gracia Hotel HOTEL,</p>
				<p>Kab.Bandung Barat,<br>Batujajar,<br>Indonesia.</p>
				<p>(+62) 865 222 44 55</p>
			</address>
		...
		<article>
			...
			<table class="inventory">
				<thead>
					<tr>
						...
						<th><span >Jumlah yang harus dibayar</span></th>
			...
			<table class="balance">
				...
				<tr>
					<th><span >saldo jatuh tempo</span></th>
					<td><span data-prefix>Rp</span><span><?php echo $fintot; ?></span></td>
				</tr>
			</table>
		</article>
		<aside>
			...
			<div >
				<p align="center">Email :- info@GRACIA.com || Web :- www.GRACIA.com || Phone :- +62 865 222 44 55 </p>
			</div>
		</aside>
	</body>
</html>
