...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>Informasi Untuk Tamu</h1>
			<address >
				<p>Gracia HOTEL,</p>
				<p>Batujajar,<br>Kabupaten Bandung Barat,<br>Indonesia.</p>
				<p>(+62) 85 222 44 55</p>
			</address>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@GRACIA.com || Web :- www.GRACIA.com || Phone :- +62 85 222 44 55 </p>
			</div>
		</aside>
	</body>
</html>
